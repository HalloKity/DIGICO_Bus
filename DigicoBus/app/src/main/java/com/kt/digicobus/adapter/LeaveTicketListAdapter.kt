...
class LeaveTicketListAdapter(var context: Context, var binding: FragmentCommuteLeaveWorkBinding, private val resource: Int, var ticketContentsList: MutableList<CommuteBusInfo>)
    : RecyclerView.Adapter<LeaveTicketHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeaveTicketHolder {
...
//            parent.findNavController().navigate(R.id.action_CommuteMainFragment_to_CommuteBusChoiceFragment2)
        ...
        return LeaveTicketHolder(itemView)
    }

    override fun onBindViewHolder(holder: LeaveTicketHolder, position: Int) {
        ...
        holder.constraint.setOnClickListener{
            ...
            binding.tvEndPlace.text = ticketContentsList[position].mainPlace
...
class LeaveTicketHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
